...
const items: Array<{ key: PageKey; label: string; icon: React.ElementType }> = [
  ...
  { key: 'newBot', label: 'Novo Bot', icon: PlusCircle },
  { key: 'liveGames', label: 'Jogos ao vivo', icon: Radio },
  { key: 'gameLists', label: 'Listas de jogos', icon: List },
  { key: 'trading', label: 'Trading em execução', icon: ChartCandlestick },
  { key: 'backtest', label: 'Backtest', icon: BarChart3 },
  { key: 'replay', label: 'Replay de jogos', icon: PlayCircle },
  { key: 'reports', label: 'Relatórios', icon: LineChart },
  { key: 'indicators', label: 'Indicadores', icon: Gauge },
  { key: 'ranking', label: 'Ranking de métodos', icon: Trophy },
  { key: 'logs', label: 'Logs dos Bots', icon: ScrollText },
